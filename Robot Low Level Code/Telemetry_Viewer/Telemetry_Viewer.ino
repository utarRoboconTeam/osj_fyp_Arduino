...
void tftDisplay(){
  ...
  if (!resetOdom){
    tft.drawCircle(110, 40, 16, TFT_WHITE);
    tft.fillCircle(110, 40, 15, TFT_BLACK);
    tft.drawCircle(110 + (int)(xPos * 10), 40 - (int)(yPos * 10), 1, TFT_WHITE);
    tft.fillRect(90, 18, 40, 4, TFT_BLACK);
    tft.drawCircle(110 - (int)(wPos * 15), 20, 1, TFT_WHITE);
